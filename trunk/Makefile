...
valgrind:
	valgrind --leak-check=full --show-reachable=yes --track-origins=yes --tool=memcheck --trace-children=yes --track-fds=yes --time-stamp=yes --num-callers=20 --error-exitcode=42 --db-attach=no --leak-check=full --leak-resolution=med -v ./$(target)
